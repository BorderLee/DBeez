...
SELECT c.cake_name AS cake_name, c.price AS price, ROUND(SUM(r.review_rate)/COUNT(r.cake_id),1) AS cake_rate
FROM Cakes c JOIN Reviews r ON c.cake_id=r.cake_id
GROUP BY c.cake_id;
